            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                        Allowance Report
                        <small>For <?php echo $allowance_list[0]->employee_first_name." ".$allowance_list[0]->employee_first_name ?></small>
                    </h1>
                    <ol class="breadcrumb">
												...
												if($employees_list!=false)
												{
													foreach($employees_list as $employee)
													{
														...
														echo '<tr><td>'.$employee->emp_firstname.' '.$employee->emp_lastname.'</td>
															  ...
															  <td>'.$job_type.'</td>
															  <td>'.$login.'</td>
															  <th><a href="#" onclick="allowance(\''.$employee->emp_id.'\')"><span class="label label-primary"  data-toggle="modal" data-target="#modal"><i class="fa fa-plus"> </i> Add Allowance</span></a> <a href="'.$link.'"><span class="label label-warning"><i class="fa fa-dashboard"> </i> Allowance Report</a></span></a>
															  </th></tr>';
													}
												}
												else
