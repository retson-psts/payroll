                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning">
                             ...
                             <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">OT Reports</h3>                                    
                                </div><!-- /.box-header -->
            ...
            $(function() {
				...
				$( "#frm" ).on( "submit", function( event ) {
        		  event.preventDefault();
					...
					$.ajax({
				type: "POST",
				url: "<?php echo site_path; ?>reports/ajax_otreport",
				dataType: "json",
				data:$( "#frm" ).serialize() ,
				success: function(html){
				if(html.status==0)
				{
					alert('Ot not added in this period');
				...
				else if(html.status==1)
				{
					...
					{
						total=parseInt(res[i].otfixed)+parseInt(res[i].ot15)+parseInt(res[i].ot2);
						txt+='<tr><td>'+i1+'</td><td>'+res[i].emp_number+'</td><td>'+res[i].emp_firstname+' '+res[i].job_title_name+'</td><td>'+res[i].job_title_name+'</td><td>'+res[i].otfixed+'</td><td>'+res[i].ot15+'</td><td>'+res[i].ot2+'</td><td>'+total+'</td></tr>';
						i1++;
					}
