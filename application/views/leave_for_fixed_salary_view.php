 <link href="<?php echo  css_path?>jQueryUI/jquery-ui-1.10.3.custom.min.css" rel="stylesheet" type="text/css"/>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Add Leave for fixed salary holders</li>
                    </ol>
                </section>
                ...
                <section class="content">
                   ...
                   <div class="form-group col-md-4">
                                        ...
                                        <input type="text" id="tags" class="form-control"  name="employee_name"/>
  ...
  $('#tags').autocomplete({            
			 source: '<?php echo site_path ?>leave_for_fixed_salary/search_fixed_employees/',				 select: function (suggestion,ui) 
			 {
             ...
             <script type="text/javascript">
				...
				$(function() {
					...
					$('#leave_type').change(function(){
						...
						$.ajax({
								url: '<?php echo site_path; ?>leave_for_fixed_salary/check_leave',
					            type: 'POST',
					            data: 'id='+id+'&employee_id='+employee_id+'&<?php echo  $this->security->get_csrf_token_name(); ?>=<?php echo  $this->security->get_csrf_hash(); ?>',
					            dataType: 'json',
					...
					$('#btn').click(function(){
						...
						$('#loader').show();
						$.ajax({
								url: '<?php echo site_path; ?>leave_for_fixed_salary/leave_list',
					            type: 'POST',
					            data: 'range='+$('#reservation').val()+'&employee_id='+employee_id+'&<?php echo  $this->security->get_csrf_token_name(); ?>=<?php echo  $this->security->get_csrf_hash(); ?>',
					            cache: false,
					            dataType: 'json',
					            success: function(data, textStatus, jqXHR)
					            {
        		  ...
        		  $('#loader').show();
		        		...
		        		var id=$('#hidden_uid').val();
		        		   ...
		        		   $.ajax({
						type: "POST",
						url: "<?php echo site_path; ?>leave_for_fixed_salary/employee_leave_add",
						dataType: "json",
						data:$( "#frm" ).serialize() ,
