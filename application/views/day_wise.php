                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning">
                             ...
                             <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Day wise Leaves</h3>                                    
                                </div><!-- /.box-header -->
...
//				    minViewMode: "months",
				...
				$( "#frm" ).on( "submit", function( event ) {
        		  event.preventDefault();
					...
					$.ajax({
				type: "POST",
				url: "<?php echo site_path; ?>reports/ajax_dayleave",
				dataType: "json",
				data:$( "#frm" ).serialize() ,
				success: function(html){
				if(html.status==0)
				{
					alert('No leaves That day');
				...
				else if(html.status==1)
				{
					...
					for(var i=0;i<res.length;i++)
					{
						...
						txt+='<tr><td>'+i1+'</td><td>'+res[i].emp_number+'</td><td>'+res[i].emp_firstname+' '+ res[i].emp_lastname+'</td><td>'+res[i].job_title_name+'</td><td>'+res[i].emp_hm_telephone+'</td><td>'+res[i].leave_type_name+'</td><td>'+res[i].leave_reason+'</td></tr>';
						i1++;
					}
