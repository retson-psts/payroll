...
<html lang="en">
  ...
  <div id="loader"></div>
    <div class="container">
    	...
    	<form action="<?php echo  site_path ?>login/login_val" id=" " name="login" role="form" class="form-horizontal form-signin" method="post" autocomplete="off">
   <input type="hidden" name="<?php echo  $this->security->get_csrf_token_name(); ?>" id="csrf_token" value="<?php echo  $this->security->get_csrf_hash(); ?>"/>
        ...
        <div class="wrap form-signin">
         <input type="text" class="form-control style1" placeholder="User ID"  name="username" value="<?php echo $username; ?>">
            <input type="password" class="form-control st" placeholder="Password" name="password">

            <button class="btn btn-lg btn-login btn-block" type="submit">
                <i class="fa fa-check"></i>Login
            </button>
            <a class="forget" href="#" data-toggle="modal" data-target="#myModal">Forget Password</a>
        	</div>
        </div>
        </form>
    	<div class="copy-right text-center">
    	<p>HR & payroll management system <br>
    	© 2016 <a href="http://www.dreamwerkztechnologies.com/" class="comp"> DWZ </a>, Inc. All rights reserved.<br></p>
