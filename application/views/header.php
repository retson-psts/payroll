...
<html>
    <head>
       ...
       <!-- <link rel="shortcut icon" href="<?php echo  images_path?>fav.ico" />-->
        ...
        <link href="<?php echo  assest_path;?>plugin/ionicon/css/ionicons.min.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo  css_path?>daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" />
        <!--<link href="http://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css" />-->
       
        
        <link href="<?php echo  css_path?>datepicker3.css" rel="stylesheet" type="text/css" />
        <link href="<?php echo  css_path?>jquery-ui.css" type="text/css">
        ...
        <!-- Morris.js charts -->
       <?php /*?>    <script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
        ...
        <!-- Bootstrap WYSIHTML5 --><?php */?>
	   <script src="<?php echo  js_path?>datepicker.js" type="text/javascript"></script>
        <!-- iCheck -->
       <?php /*?> <script src="<?php echo  js_path?>plugins/iCheck/icheck.min.js" type="text/javascript"></script>
<?php */?>
        <!-- AdminLTE App -->
    ...
    <body class="skin-blue">
        ...
        <header class="header">
            ...
            <a href="<?php echo site_path; ?>home" class="logo">
           		<?php echo $company['company_name'] ?>
                <!-- Add the class icon to your logo image or logo icon to add the margining -->
                <?php echo  ''//$user_info['first_name'].'&nbsp;'.$user_info['last_name']; ?>
                <!--<img src="<?php echo assest_path;?>images/log.png" style="height: 48px;float:left"> DWZ-->
            </a>
            ...
            <nav class="navbar navbar-static-top" role="navigation">
                ...
                <div class="company_name"><img src="<?php echo  assest_path ?>images/logo1.jpg" style="float: left; height: 40px;" alt="DWZ"/> <span class="hr"> DWZ HR & Payroll Management System</span></div>
                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-footer">
                                    <div class="pull-left">
                                        <a href="<?php echo  site_path.'user_profile'; ?>" class="btn btn-default btn-flat">Profile</a>
                                    </div>
                                    <div class="pull-right">
                                        <a href="<?php echo  site_path.'home/logout'; ?>" class="btn btn-default btn-flat">Sign out</a>
                                    </div>
                                </li>
                            </ul>
                        </li>
