                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-12">
                            ...
                            <h2 class="page-header">
                                ...
                                <small class="pull-right">Date: <?php $date11=new dateTime($total_details['salary_master_generared']);

                                echo $date11->format('d M, Y'); ?></small>
                    ...
                    <div class="row invoice-info">
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address>
                               ...
                               Email: <?php echo $company_details['company_email']; ?><br>
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <address>
                                ...
                                <strong>[<?php echo $total_details['ei_permit_number'];  ?>]</strong><br>

                                <?php echo $total_details['emp_contact_temp_street1']; ?>,<br>

                                <?php echo $total_details['emp_contact_temp_street2']; ?><br>

                                <?php echo $total_details['city_name'];  ?><br>
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>Basic Salary (<?php echo $total_details['employee_master_basic_salay']; ?>)</td>
                                    ...
                                    <?php if($total_details['cpf_employer']!=0){ ?>

                                    <tr>

                                        <td>EMPLOYER CPF</td>

                                        <td>Contribution By Employer</td>

                                        <td>$ <?php echo $total_details['cpf_employer']; ?></td>
                                    ...
                                    <?php if($total_details['salary_deduction']!=0){ 

                                    

                                    $res=json_decode($total_details['deduction_details']);
...

                                    {
                                    	...
                                    	echo "<td>".$item->dec_name."(".$item->sld_notes.")</td>";

                                    	echo "<td>Deduction</td>";

                                    	echo "<td>$ ".$item->sld_amount."</td>";
                                    ...
                                    <!--<tr>
                                        ...
                                        <td>$ <?php echo $total_details['salary_deduction']; ?></td>
