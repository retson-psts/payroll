                ...
                <section class="content-header">
                    <h1>
                       Project Wise Reports 
                        <small>Project Wise reports</small>
                    </h1>
                    <ol class="breadcrumb">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning">
                                      ...
                                      <div class="box-body">
                                         <div class="add_form" >
                                            ...
                                            <div class="form-group col-md-3">
                                                <label >Project</label>
                                               <select class="form-control" required name="project" onchange="change_project(this);">
                             ...
                             <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">Projects Wise Report</h3>                                    
                                </div><!-- /.box-header -->
            ...
            $(function() {
				...
				$( "#frm" ).on( "submit", function( event ) {
        		  event.preventDefault();
					...
					$.ajax({
				type: "POST",
				url: "<?php echo site_path; ?>reports/ajax_project",
				dataType: "json",
				data:$( "#frm" ).serialize() ,
				...
				else if(html.status==1)
				{
					...
					for(var i=0;i<res.length;i++)
					{
						...
						txt+='<tr><td>'+i1+'</td><td>'+res[i].emp_number+'</td><td>'+res[i].emp_firstname+' '+res[i].emp_lastname+'</td><td>'+res[i].job_title_name+'</td><td>'+res[i].otfixed+'</td></tr>';
						i1++;
					}
