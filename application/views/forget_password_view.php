...
<html class="lockscreen">
    <head>
        ...
        <!-- Theme style -->
        <link href="<?php echo  assest_path?>css/AdminLTE.css" rel="stylesheet" type="text/css" />
    ...
    <body>
        ...
        <div class="center">            
            ...
            <!-- User name -->
            <div class="lockscreen-name"><?php echo $message_div; ?></div>
            
            <!-- START LOCK SCREEN ITEM -->
            <div class="lockscreen-item">
                <!-- lockscreen image -->
                <div class="lockscreen-image">
                    <img src="<?php echo  assest_path; ?>img/avatar5.png" alt="user image"/>
                </div>
                <!-- /.lockscreen-image -->
