            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    { ?>
                        Add Employee
                        <small>Skills</small>
                        <?php } else { echo "Edit Employee<small>Skills</small>";  } ?>
                                ...
                                <div class="col-md-12 " >
                                  ...
                                  <div class="add_panel">
                                    <div class="box-header">
                                        <h3 class="box-title">Employee Skills</h3>
                                    </div><!-- /.box-header -->
                                    ...
                                    <div id="add_form" >
                                      <div class="box-body">
                                        <div class="form-group col-md-4">
                                             <label for="esk_skill">Skill *</label>
                                             <select class="form-control" name="esk_skill_id" id="esk_skill_id">
                                             <option value="">Select type</option>
											  ...
											  {
												  echo '<option>-- Please Add Skills ----</select>';
											  }
                                              ?>
                                              </select>
                                        </div>
                                      ...
                                      <div class="form-group col-md-4">
                                         <label for="esk_skill_comment">Comments</label>
                                         <textarea class="form-control" name="esk_skill_comment" id="esk_skill_comment"><?php echo  $form_data['esk_skill_comment'] ?></textarea>
                                      </div>
                                      <div class="clearfix"></div>
                                      ...
                                      <div class="box-footer text-center">
                                            ...
                                            <?php if(!isset($edit))
                    			{ ?>
                     		 <a href="<?php echo site_path ?>add_employee/employee_photo/<?php echo $employee_id; ?>" class="btn btn-info text-center">Next</a>
                        ...
                        <?php   } ?> 
                                  ...
                                  <div class="list_results">
                                  	  <div class="added_data">
                                      	 <div class="box-header">
                                             <h3 class="box-title">Assigned Skill Records</h3>
                                         </div><!-- /.box-header -->
                                         <?php
										 if($emp_skills!=false)
									     {
										 ?>
                                          ...
                                          <table id="example1" class="table table-bordered table-striped">
											  ...
											  {
												  //print_r($emp_immigration);
												  $name='<a href="#" onclick="enable_edit(\''.$emp_skill->esk_id.'\',\''.$emp_skill->esk_skill_id.'\',\''.$emp_skill->esk_skill_comment.'\'); return false;" id="rel_'.$emp_skill->esk_id.'">'.$emp_skill->skill_name.'</a>';
												   $option='<a href="#" onclick="delete_my(this,\''.$emp_skill->esk_id.'\'); return false;" >Remove</a>';
												  echo '<tr id="esk_'.$emp_skill->esk_id.'">
												  		<td>'.$name.'</td>
												  		<td>'.$emp_skill->esk_skill_comment.'</td>
														<td>'.$option.'</td></tr>';
											  }
											  ?>
											  </tbody>
                              ...
                              <div class="attachments">
                                   ...
                                   <div class="attachment_add">
                                       ...
                                       <div id="error_file"></div>
                                        ...
                                        <input type="hidden" name="<?php echo  $this->security->get_csrf_token_name(); ?>" id="csrf_token" value="<?php echo  $this->security->get_csrf_hash(); ?>"/>
                                        <input type="hidden" name="screen" value="esk" />
                                    ...
                                    <div class="list_results">
                                  	  <div class="added_data">
                                      	 <div class="box-header">
                                             <h3 class="box-title">Attachments Employee Skills</h3>
                                         </div><!-- /.box-header -->
                                         <?php
 ...
 <form role="form"  action="#" method="post" enctype="multipart/form-data" id="form_edit">
        ...
        <h4 class="modal-title">Edit Employee Dependent </h4>
         ...
         <script type="text/javascript">
         		function enable_edit(id,name,comment)
            	{
					$("#form_edit [name='esk_skill_id']").val(name);
					$("#form_edit [name='esk_skill_comment']").html(comment);
        ...
        function delete_my(e,id)
        	{
        		...
        		$('#loader').show();
        		 $.ajax({
				type: "GET",
				url: "<?php echo site_path; ?>validation/remove_esk/"+id,
				dataType: "json",
    ...
    startView: "decade"
				...
				$('#loader').show();
        		  $.ajax({
				type: "POST",
				url: "<?php echo site_path; ?>validation/step10",
				dataType: "json",
			...
			return false;
				...
				$('#loader').show();
        		  $.ajax({
				type: "POST",
				url: "<?php echo site_path; ?>validation/step10_1",
				dataType: "json",
				...
				{
						$('#result').html('Skills updated successfully');
