                      ...
                      <div class="add_panel">
                        ...
                        <div id="add_form" >
                          ...
                          <div class="box-footer text-center">
                                ...
                                <?php if(!isset($edit))
        			{ ?>
         		 <a href="<?php echo site_path ?>add_employee/employee_immigration/<?php echo $employee_id; ?>" class="btn btn-info text-center">Next</a>
                      	  ...
                      	  <div class="added_data">
							 ...
							 ?>
                              ...
                              <table id="example1" class="table table-bordered table-striped">
								  ...
								  {
									  $name='<a href="#" onclick="enable_edit('.$emp_dependent['ed_id'].',\''.$emp_dependent['ed_name'].'\',\''.$emp_dependent['ed_relationship_type'].'\',\''.$emp_dependent['ed_relationship'].'\',\''.$emp_dependent['ed_date_of_birth'].'\'); return false;" >'.$emp_dependent['ed_name'].'</a>';
									  $options='<a href="#" onclick="delete_my(this,'.$emp_dependent['ed_id'].'); return false;" >Remove</a>';
...
$('#loader').show();
 $.ajax({
	type: "GET",
	url: "<?php echo site_path; ?>validation/remove_ed/"+id,
	dataType: "json",
...
$( "#form_add" ).on( "submit", function( event ) {
  ...
  $.ajax({
	type: "POST",
	url: "<?php echo site_path; ?>validation/step4",
	dataType: "json",
...
return false;
  ...
  $.ajax({
	...
	{
			$('#result').html('Dependents  updated successfully');
