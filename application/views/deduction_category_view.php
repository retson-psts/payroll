<style>
		...
		float:right;
          ...
          <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Deduction Category</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-warning">
                                <div class="box-header">
								  ...
								  <h3 class="box-title">Add Deduction Category</h3>                                    
                                </div><!-- /.box-header -->
                                <form id="form_add" action="<?php echo  site_path?>job_category/update_cat" method="post">
                                      <div class="box-body">
                                         ...
                                         <div id="error_add"></div>
                                            ...
                                            <div class="form-group col-md-4">
                                                <label for="job_title_name">Deduction Title *</label>
                                                <input type="text" class="form-control" name="dec_name" id="dec_name" placeholder="Deduction Title">
                                            </div>
                                            <div class="form-group col-md-4">
                                            <label for="employement_status">Deduction Description</label>
                                             <textarea name="dec_description" class="form-control"></textarea>
                                           </div>
                                    ...
                                    <div class="box-footer">
                                        <div class="clearfix"></div>
                                        <div class="cat_save">
                                        	<button type="submit" name="submit" class="btn btn-primary text-center" id="save">Save Deduction</button>
                                        ...
                                        <?php
											if(!empty($dec))
											{
												...
												foreach($dec as $item)
												{
													...
													echo "<tr>";
													echo "<td>".$sno."</td>";
													echo "<td>".$item['dec_name']."</td>";
													echo "<td>".$item['dec_description']."</td>";
													echo '<td><a href="#" onclick="enable_edit(\''.$item['dec_id'].'\',\''.$item['dec_name'].'\',\''.$item['dec_description'].'\');" ><span class="label label-primary"><i class="fa fa-edit"> </i> View / Edit</span></a>  <a href="#" onclick="delete_my(this,'.$item['dec_id'].');" ><span class="label label-warning"><i class="fa fa-trash-o"> </i> Delete</a></span></td>';
													echo "</tr>";
 ...
 <form role="form"  action="#" method="post" enctype="multipart/form-data" id="form_edit">
        ...
        <h4 class="modal-title">Edit Deduction Category </h4>
      </div>
				      <div class="modal-body">
        ...
        <script src="<?php echo  js_path?>plugins/datatables/dataTables.bootstrap.js" type="text/javascript"></script>      
         ...
         <script type="text/javascript">
        	...
        	{
				$("#form_edit [name='dec_name']").val(name);
				$("#form_edit [name='id']").val(id);
				$("#form_edit [name='dec_description']").val(login);
			...
			function delete_my(e,id)
        	{
        		...
        		$('#loader').show();
        		 $.ajax({
				type: "GET",
				url: "<?php echo site_path; ?>deduction_category/remove/"+id,
				dataType: "json",
			...
			$('#editModal').on('hidden.bs.modal', function () {		 
				...
				$('#loader').show();
        		  $.ajax({
				type: "POST",
				url: "<?php echo site_path; ?>deduction_category/add",
				dataType: "json",
			...
			return false;
				...
				$('#loader').show();
        		  $.ajax({
				type: "POST",
				url: "<?php echo site_path; ?>deduction_category/edit",
				dataType: "json",
