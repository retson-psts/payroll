            ...
            <div class="col-xs-6 col-xs-offset-3">
              <div class="box ">
                ...
                <?php echo $message_div; ?>
                  <form role="form" id="edit_skill" action="<?php echo admin_path; ?>edit_skill_process" method="post">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="skill_id" value="<?php echo $form_data['skill_id'] ?>" class="btn btn-primary">Submit</button>
