            ...
            <div class="col-xs-6 col-xs-offset-3">
              <div class="box ">
                ...
                <?php echo $message_div; ?>
                  <form role="form" id="edit_city" action="<?php echo admin_path; ?>edit_city_process" method="post">
                  ...
                  <div class="box-footer">
                    <button type="submit" name="city_id" value="<?php echo $form_data['city_id'] ?>" class="btn btn-primary">Submit</button>
